...
//mf#define wm8731_reset(c)	snd_soc_write(c, WM8731_RESET, 0)
...
//mf	return snd_soc_update_bits(codec, WM8731_APDIGI, 0x6, val);
...
//mf	snd_soc_write(codec, WM8731_SRATE, srate);
		...
		unsigned int fmt)
{
	...
	case SND_SOC_DAIFMT_DSP_A:
		iface |= 0x0013;				// confirmed at github.com/torvalds
		break;
...
//	i2c_set_clientdata(i2c, wm8731);
//mf	i2c_set_clientdata(i2c, wm8731);
